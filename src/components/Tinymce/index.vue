    ...
    export default {
        ...
        props: {
            ...
            toolbar: {
                ...
                required: false,
                default() {
                    return ['removeformat undo redo |  bullist numlist | outdent indent | forecolor | fullscreen code', 'bold italic blockquote | h1 h2  p  link | alignleft aligncenter alignright | h3 ']
                }
            },
            menubar: {
                default: ''
...
//           },
                setup(editor) {
                    ...
                    editor.addButton('h1', {
                        title: '大标题', // tooltip text seen on mouseover
                        text: '大标题',
                        onclick() {
